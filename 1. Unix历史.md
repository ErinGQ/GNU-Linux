...
Unix
GNU/Linux基础<p style="text-align:right;font-size:28px;margin-right:50px;color:#cFc;">:star: by calidion</p>
===
---
...
自由软件运动（1981-1991）
===
创建人：Richard M Stallman
项目名：GNU 操作系统
事件：1985年发布了GNU宣言（GNU manifesto）
主张废除软件知识产权
发明自由软件以自由软件
